...
define title
	...
	@printf "$(GREEN)%*s\n" $$(( ( $(shell echo "$(ICON)$(1) $(ICON)" | wc -c ) + 100 ) / 2 )) "$(ICON)$(1) $(ICON)"
	@printf "$(GREEN)____________________________________________________________________________________________________\n$(ORANGE)"
endef
...
install-dev-tools:
	...
	@cd $(MAKEFILE_DIR) \
		...
		&& go install k8s.io/kubectl@5f197f4147e2a804baf17a2214296da6a3bcda9b \
		&& go install github.com/kubernetes-sigs/kind@6cb934219ac54aa0ddb1d8313adc05304421ccb6
