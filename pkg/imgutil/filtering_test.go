...
func TestMatchesAnyLabel(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			imageLabels:   map[string]string{"org": "com.example.clitest"},
			labelsToMatch: map[string]string{"org": "com.example.clitest"},
			matches:       true,
		},
		{
		...
		},
		{
			...
			imageLabels:   map[string]string{"org": "com.example.clitest", "foo": "bar"},
