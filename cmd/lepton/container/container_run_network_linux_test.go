...
import (
	...
	"github.com/farcloser/lepton/pkg/testutil/nettestutil"
)
...
func TestRunWithInvalidPortThenCleanUp(t *testing.T) {
	...
	base.Cmd("run", "--rm", "--name", containerName, "-p", "22200-22299:22200-22299", testutil.CommonImage).AssertCombinedOutContains(errs.ErrInvalidArgument.Error())
