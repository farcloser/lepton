...
import (
	...
	container2 "github.com/farcloser/lepton/cmd/lepton/container"
	"github.com/farcloser/lepton/cmd/lepton/helpers"
	image2 "github.com/farcloser/lepton/cmd/lepton/image"
...
func inspectAction(cmd *cobra.Command, args []string) error {
	...
	if inspectImage {
		platform := ""
		imageInspectOptions, err = image2.ProcessImageInspectOptions(cmd, &platform)
		if err != nil {
			return err
		}
	}
	if inspectContainer {
		containerInspectOptions, err = container2.ProcessContainerInspectOptions(cmd)
		if err != nil {
			return err
		}
	}
