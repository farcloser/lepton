...
services:
  svc0:
    ...
    image: %s
    x-%s-verify: cosign
    x-%s-cosign-public-key: %s
    x-%s-sign: cosign
    x-%s-cosign-private-key: %s
    entrypoint:
      - stty
  svc1:
    build: .
    image: %s
    x-%s-verify: cosign
    x-%s-cosign-public-key: dummy_pub_key
    x-%s-sign: cosign
    x-%s-cosign-private-key: %s
    entrypoint:
      - stty
  svc2:
    ...
    entrypoint:
      - stty
`, imageSvc0, version.RootName, version.RootName, keyPair.PublicKey, version.RootName, version.RootName, keyPair.PrivateKey,
		imageSvc1, version.RootName, version.RootName, version.RootName, version.RootName, keyPair.PrivateKey, imageSvc2, version.RootName, version.RootName)
