...
var imageEncryptHelp = fmt.Sprintf(`Encrypt image layers.
...
To see non-encrypted information, run '%s image inspect --mode=native --platform=PLATFORM example.com/foo:encrypted' .
`, version.RootName, version.RootName, version.RootName)
