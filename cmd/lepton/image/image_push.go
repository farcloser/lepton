...
func NewPushCommand() *cobra.Command {
	...
	pushCommand.RegisterFlagCompletionFunc("platform", completion.PlatformNames)
...
func processImagePushOptions(cmd *cobra.Command) (types.ImagePushOptions, error) {
	...
	signOptions, err := helpers.ProcessImageSignOptions(cmd)
	if err != nil {
		return types.ImagePushOptions{}, err
	}
	sociOptions, err := helpers.ProcessSociOptions(cmd)
	if err != nil {
		return types.ImagePushOptions{}, err
	}
