...
Using `go install github.com/containerd/nerdctl/v2/cmd/lepton` is possible, but unrecommended because it does not fill version strings printed in `nerdctl version`
